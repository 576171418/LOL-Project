...
typealias customAlertViewClickAction = (Int,CustomAlertView) -> ()
...
class CustomAlertView: UIView {
    ...
    init(frame : CGRect,title: String, message: String, confirmTitle: String, cancleTitle: String, isShowTop:Bool, topTitle: String) {
        ...
        if isShowTop {
            ...
            self.topLabel?.font = UIFont.systemFont(ofSize: 16)
    ...
    func GetAdaptiveLable(_ rect: CGRect, AndText contentStr: String, andIsTitle isTitle: Bool) -> UILabel {
        ...
        mAttrStr.addAttribute(NSAttributedString.Key.paragraphStyle, value: mParaStyle, range: NSMakeRange(0, contentStr.count))
